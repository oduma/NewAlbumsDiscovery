...
## Task
Identify up to **{{maxAlbums}}** music albums (LPs, EPs, or major studio releases) released in **{{country}}** **{{timeframe}}** (e.g., "between 13-JUL-2026 and 13-AUG-2026") that belong to ANY of the following genres: **{{genres}}** and feature at least one track sung or performed in **{{language}}**.
